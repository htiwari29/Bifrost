...
public class DatabaseFailureException extends UserException {
    ...
    public static DatabaseFailureException whileRetrievingUserById(Exception ex){
        log.error("Database failure exception while retrieving user by id");
        throw new DatabaseFailureException(ex, ErrorFactory.databaseFailureExceptionWhileRetrievingUserById());
    }
